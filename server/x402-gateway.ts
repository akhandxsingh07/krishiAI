...
app.get('/api/premium-procurement', (_req, res) => {
  ...
  return res.json({
    ...
    marketSignal: 'Demo premium procurement signal unlocked after x402 settlement.',
    recommendation:
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(`🔐 KrishiAI x402 gateway running at http://0.0.0.0:${PORT}`);
  console.log(`🔗 Core KrishiAI server proxied from ${CORE_SERVER}`);
});
